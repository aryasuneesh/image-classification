...
def train(model, train_loader, validation_loader, criterion, optimizer, device, early_stopping):
    epochs = 2
    best_loss = 1e6
...
def main(args):
    logger.info(
        f'Hyperparameters are LR: {args.learning_rate}, Batch Size: {args.batch_size}, Early Stopping: {args.early_stopping_rounds}')
